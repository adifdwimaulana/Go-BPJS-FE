...
const RequestMedicine = React.lazy(()=> import ('./Demo/RequestMedicine/RequestMedicine'))
...
const routes = [
    ...
    { path: '/management/reqmed', exact: true, name: 'Management Medicine Request', component: RequestMedicine },
