...
const DocumentRequest = (props) => {
  ...
  const handleDate = (date, type) => {
    const fixDate = moment(date).format(
      type === "ttd" ? "DD-MMMM-YYYY" : "YYYY/MM/DD"
    );
    return fixDate;
  };
              ...
              <Document>
                <Page size="A4">
                  ...
                  <Text style={styles.title2}>
                    Dokumen{" "}
                    {requestMedicines ? "Permintaan Obat" : "Pemeriksaan"}
                  </Text>
                  <View style={styles.body}>
                    <View style={styles.row}>
                      ...
                      >
                        ...
                        <Text style={{ textAlign: "left", marginRight: 5 }}>
                          :{" "}
                        </Text>
                      </View>
                      <Text
                    ...
                    >
                      <Text style={{ marginBottom: 10 }}>
                        {requestMedicines ? "Menyetujui" : "Mengetahui"}
                      </Text>
                      <Text style={{ marginBottom: 70 }}>
                        Tangerang Selatan, {handleDate(data?.date || "", "ttd")}
                      </Text>
