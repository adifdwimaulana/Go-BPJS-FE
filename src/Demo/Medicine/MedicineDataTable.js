...
class MedicineDataTable extends React.Component {
      ...
      <div>
        {
          <div>
            ...
            <Button
              onClick={() => this.toggleOpenDelete(row)}
              size="sm"
              variant="danger"
            >
  ...
  customBtnGroup = (props) => {
    return (
      <div>
        <Button onClick={() => this.toggleOpenAdd()} variant="primary">
          <i className="fa fa-plus"></i>&nbsp;Tambah Data Obat
        </Button>
        {props.exportCSVBtn}
      </div>
    );
  ...
  showTable = () => {
    ...
    return (
      <BootstrapTable
        ...
        pagination
        search
        searchPlaceholder={"Cari berdasarkan nama obat atau deskripsi..."}
        edit
        options={options}
        selectRow={selectRow}
        exportCSV={true}
      ...
      >
        ...
        <TableHeaderColumn
          ...
          thStyle={{ whiteSpace: "normal", width: 300 }}
          tdStyle={{ whiteSpace: "normal", width: 300 }}
          searchable={false}
          expandable={false}
        >
          Action
    ...
    return (
      <div>
        ...
        <Confirmation
          ...
          toggleCloseConfirm={() =>
            this.setState({ confirm: !confirm, message: null, isLoading: null })
          }
        />
      </div>
    );
